 ...
 */
final class Version20230703114954 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE precommande ADD CONSTRAINT FK_7A250B45131A4F72 FOREIGN KEY (commune_id) REFERENCES commune (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE precommande ADD CONSTRAINT FK_7A250B45D0165F20 FOREIGN KEY (type_activite_id) REFERENCES type_activite (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
